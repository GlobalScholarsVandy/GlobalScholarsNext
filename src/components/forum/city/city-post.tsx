...
const CityPost = () => {
  ...
  return (
    <MakePostBox>
      <span className="h-full w-full text-[16px]">
        <form className="flex flex-col align-middle">
          ...
          <div className="my-1 flex flex-col rounded-lg border-2 border-black">
            <div
              className={
                open ? "w-100 h-80 font-medium" : "w-100 h-10 font-medium"
              }
            >
              <div
          ...
          <FormInputSectionContainer>
            ...
            <GuidelinesBox>
              <p className="m-2 font-bold">Guidelines</p>
          ...
          <FormInputSectionContainer>
            ...
            <div className="mx-2 my-1 mb-2 flex justify-between">
